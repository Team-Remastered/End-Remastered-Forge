...
public class ERBlocks {
    ...
    public static final RegistryObject<Item> ANCIENT_PORTAL_FRAME_ITEM = BLOCK_ITEMS.register("ancient_portal_frame", () -> new BlockItem(ANCIENT_PORTAL_FRAME.get(), new Item.Properties().tab(EndRemastered.TAB)));
}
